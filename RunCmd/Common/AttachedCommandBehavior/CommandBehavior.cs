...
namespace RunCmd.Common.AttachedCommandBehavior
{
    ///This very useful utility comes from here: http://marlongrech.wordpress.com/2008/12/04/attachedcommandbehavior-aka-acb/
    ///Used to attach command to events
    /// <summary>
